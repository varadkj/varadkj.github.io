...
While that ran, I inspected the upload form using Burp, which didn't lead to anything useful.
...
On Googling for "windows media player file upload attacks" we get 'NTLM Credential Theft' because it mentions bypassing user interaction since we do not have any user access!

![Google Search Results](/assets/img/posts/media/search.png)

This led me to https://www.morphisec.com/blog/5-ntlm-vulnerabilities-unpatched-privilege-escalation-threats-in-microsoft/#:~:text=4.,%E2%80%9CBy%2DDesign%E2%80%9D%20Vulnerability
...
Let's upgrade to a PowerShell session using Nishang:
...
Looking at index.php and review.ps1 which we found earlier:
...
![Testing Webshell](/assets/img/posts/media/php2.png)
...
The `SeImpersonatePrivilege` looks interesting but is disabled. Reading online led me to https://github.com/v4resk/red-book/blob/main/redteam/privilege-escalation/windows/abusing-tokens.md

Which led me to https://github.com/itm4n/FullPowers/releases/tag/v0.1
